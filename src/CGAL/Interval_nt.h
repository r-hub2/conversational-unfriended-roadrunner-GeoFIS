...
//
// $URL: https://github.com/CGAL/cgal/blob/v5.1.1/Number_types/include/CGAL/Interval_nt.h $
...
# else
   // warning: ISO C++ forbids braced-groups within expressions [-Wpedantic] in R package compilation
...
# endif
  ...
  Interval_nt(long long i)
  {
    ...
    *this = d;
#if defined(__GNUC__) && !defined(R_PACKAGE)
