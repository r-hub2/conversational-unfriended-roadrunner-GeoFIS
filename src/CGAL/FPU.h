...
#if defined(CGAL_HAS_SSE2) && (defined(__x86_64__) || defined(_M_X64)) && !defined(R_PACKAGE)
...
# elif defined __GNUC__ && !defined __INTEL_COMPILER \
  ...
  // warning: ISO C++ forbids compound-literals [-Wpedantic] in R package compilation
