...
//
// $URL: https://github.com/CGAL/cgal/blob/v5.1.1/STL_Extension/include/CGAL/Handle.h $
...
class Handle
{
  public:
    ...
    ~Handle()
    {
#if defined(__MINGW32__) && (__GNUC__ == 8) && (__GNUC_MINOR__ == 3)
		// ununderstandable segfault in this configuration (Rtools 4.0)
#else
        if ( PTR && (--PTR->count == 0))
            delete PTR;
#endif		
