...
//
// $URL: https://github.com/CGAL/cgal/blob/v5.1.1/Number_types/include/CGAL/boost_mp.h $
...
# ifdef R_PACKAGE
   // warning: ISO C++ does not support '__int128' [-Wpedantic] in R package compilation
